...
//			System.out.println(classDefinition.toString());
	...
	public void  populateAssociations( ClassDefinition classDefinition,  Map<String, List<Association>>  map, ClassRelations classRelations){
	...
	public void  populateAggregations( ClassDefinition classDefinition,  Map<String, List<Association>>  map, ClassRelations classRelations){
	...
	public void  populateCompositions( ClassDefinition classDefinition,  Map<String, List<Association>>  map, ClassRelations classRelations){
	...
	public String  getAggregations(  ){
		...
		for (Link link:classRelations.getAggregationLinks().values()){
			buffer.append(link.getSource()).append(" ").append('"').append(link.getSource_number() != null?link.getSource_number(): "1").append('"').append(" ");
			buffer.append(AGGREGATION).append(" ").append('"').append(link.getTarget_number()!= null? link.getTarget_number() : "1" ).append('"').append(" ").append(link.getTarget());
			buffer.append("\n");
	...
	public String  getCompositions(  ){
		...
		for (Link link:classRelations.getCompositionLinks().values()){
			buffer.append(link.getSource()).append(" ").append('"').append(link.getSource_number() != null?link.getSource_number(): "1").append('"').append(" ");
			buffer.append(COMPOSITION).append(" ").append('"').append(link.getTarget_number()!= null? link.getTarget_number() : "1" ).append('"').append(" ").append(link.getTarget());
			buffer.append("\n");
